    ...
    return ScanResult(
        ...
        diagnostics={
            ...
            **broker_recency,
            ...
            "execution_entry_basis": sf.get("entry_basis"),
            "execution_stop_basis": sf.get("stop_basis"),
            "execution_target_basis": sf.get("target_basis"),
            "execution_rr1": sf.get("execution_rr1"),
            "execution_rr2": sf.get("execution_rr2"),
            "execution_rr_floor_pass": sf.get("execution_rr_floor_pass"),
            "execution_target_candidate_count": sf.get("target_candidate_count"),
            "execution_target_basis": sf.get("target_basis"),
